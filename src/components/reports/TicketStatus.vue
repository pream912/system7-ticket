    ...
    computed: {
        ...
        filt_tickets() {
            if(this.selected_status == 'All') {
                return this.prepTickets(this.tickets)
            } else if(this.selected_status == 'Open') {
                return this.prepTickets(this.opentickets)
            } else if(this.selected_status == 'Followup') {
                return this.prepTickets(this.followups)
            } else {
                return this.prepTickets(this.closedtickets)
            }
        },
